    ...
    const config = [
        {
            ...
            'items': ['Citrix ADC in Tier 1', 'Service Type LB']
        },
        {
            'title': '2 Tier Ingress',
            'items': ['CPX in Tier 2', 'Service Mesh Lite']

        },
        {
            'title': 'Service Mesh',
            'items': ['Istio Ingress Gateway', 'CPX as Istio Sidecar']
        },
        {
            'title': 'Components',
            'items': ['Citrix Observability Exporter', 'Citrix Node Controller']
        }
    ]
        ...
        <>
            ...
            <Sidebar.Pushable attached={'top'} basic as={Segment} style={{ marginTop: '0', borderRadius: '0', borderTop: '0', borderBottom: '0' }}>
                <Sidebar
                    ...
                    width='wide'
                >
                    <SidebarItems config={config} onClick={itemClick} />
                </Sidebar>
                <Sidebar.Pusher>
